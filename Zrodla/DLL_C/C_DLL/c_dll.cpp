...
void C_DLL::SingleColorChannel_Red_CPP(unsigned char * r, unsigned char * g, unsigned char * b)
{
	...
	_mm_storeu_si128(g_sse, *r_sse);
	_mm_storeu_si128(b_sse, *r_sse);
}
...
void C_DLL::SingleColorChannel_Green_CPP(unsigned char * r, unsigned char * g, unsigned char * b)
{
	...
	_mm_storeu_si128(r_sse, *g_sse);
	_mm_storeu_si128(b_sse, *g_sse);
}
...
void C_DLL::Decomposition_max_CPP(unsigned char* r, unsigned char* g, unsigned char* b)
{
	...
	_mm_storeu_si128(r_sse, _mm_max_epu8(_mm_loadu_si128(r_sse), _mm_max_epu8(_mm_loadu_si128(g_sse), _mm_loadu_si128(b_sse))));
	_mm_storeu_si128(b_sse, *r_sse);
	_mm_storeu_si128(g_sse, *r_sse);
}
...
void C_DLL::Decomposition_min_CPP(unsigned char * r, unsigned char * g, unsigned char * b)
{
	...
	_mm_storeu_si128(r_sse, _mm_min_epu8(_mm_loadu_si128(r_sse), _mm_min_epu8(_mm_loadu_si128(g_sse), _mm_loadu_si128(b_sse))));
	_mm_storeu_si128(b_sse, *r_sse);
	_mm_storeu_si128(g_sse, *r_sse);
}
...
void C_DLL::Desaturation_CPP(unsigned char * r, unsigned char * g, unsigned char * b)
{
	...
	_mm_storeu_si128(&min, _mm_min_epu8(_mm_loadu_si128(r_sse), _mm_min_epu8(_mm_loadu_si128(g_sse), _mm_loadu_si128(b_sse))));
	_mm_storeu_si128(&max, _mm_max_epu8(_mm_loadu_si128(r_sse), _mm_max_epu8(_mm_loadu_si128(g_sse), _mm_loadu_si128(b_sse))));
	 
	_mm_storeu_si128(&min, _mm_srli_epi16(min, 1));
	_mm_storeu_si128(&max, _mm_srli_epi16(max, 1));

	_mm_storeu_si128(r_sse, _mm_adds_epu8(min,max));
	_mm_storeu_si128(b_sse, *r_sse);
	_mm_storeu_si128(g_sse, *r_sse);
}